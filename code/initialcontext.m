...
switch dataset
    ...
    case 'campus'
        ...
        % training / testing partition
        if exist([cache_dir, 'partition.mat'], 'file')
            
            load([cache_dir, 'partition.mat']);
            ...
            save([cache_dir, 'partition.mat'], 'partition');
            
        end
        
        ptrn = partition(TRIAL).ptrn;
        ptst = partition(TRIAL).ptst;
end
